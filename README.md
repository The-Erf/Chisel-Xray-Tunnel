...
اگر اتصال برقرار بود اما بهتون پینگ نمیداد یا پینگش استیبل نبود احتمالا بخاطر تنظیمات Mux هستش که احتمالا با فعال و تنظیم کردنش مطابق کد زیر مشکل رفع میشه
