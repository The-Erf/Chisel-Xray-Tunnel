...
به این صورت که شما سرور خارجتون رو میبرید پشت cdn کلادفلر و این تانل رو روی سرور ایران برقرار میکنید،حالا فقط باید در قسمت Address کانفیگتون،ایپی یا دامنه سرور ایرانتون رو وارد کنید که اگه از دامنه استفاده میکنید فقط کافیه از پشت دامنه ip سرور ایران رو جایگزین ip سرور خارجتون کنید و تمام:) یوزراتون بدون تغییری در کانفیگ با سرعت قابل قبولی متصل میشن و دیگه اهمیت نداره ایپی سرور خارجتون تمیزه یا نه😅
