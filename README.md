...
خب اینجا دقیقا همون جایی هستش که گفتم باید Chisel رو با ایده های خودتون ترکیب کنید! مثلا من 2 تا مثال ساده برای درک و شناخت بهتر براتون میزنم که میتونید ازشون استفاده کنید یا ایده بگیرید :)
...
## اتصال با متود Forwarder - اکانتینگ : خارج
اگر میخواید یوزر هاتون روی روی سرور دوم (خارج) بسازید و مدیریت کنید میتونید از این روش استفاده کنید، فقط کافیه کانفیگی که ساخته بودید با پورت 443 و بعد از روشن کردن CDN از دسترس خارج شد رو ویرایش کنید ادرس رو به ایپی یا دامنه سرور اول (ایران) تغییر بدید 
و پورتی که برای Chisel در سرور ایران انتخاب کرده بودیم را وارد کنیم
